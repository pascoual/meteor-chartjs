...
(function() {
  ...
  if (typeof Package !== 'undefined') {
    TmpChart = Chart; // For Meteor
  } else if (typeof amd !== 'undefined') {
		define(function() {
			return Chart;
		});
	...
	var LinearScale = Chart.Scale.extend({
		buildTicks: function() {
			...
			if (this.isHorizontal()) {
				...
				maxTicks = Math.min(this.options.ticks.maxTicksLimit ? this.options.ticks.maxTicksLimit : 11, Math.ceil(this.height / (2 * this.options.ticks.fontSize)));
			}
...
(function() {
	...
	var LinearRadialScale = Chart.Scale.extend({
		...
		buildTicks: function() {
			...
			// We also limit the maximum number of ticks to 11 which gives a nice 10 squares on 
			// the graph
			var maxTicks = Math.min(this.options.ticks.maxTicksLimit ? this.options.ticks.maxTicksLimit : 11, Math.ceil(this.drawingArea / (1.5 * this.options.ticks.fontSize)));
